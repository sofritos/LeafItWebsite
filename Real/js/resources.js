...
if(state=="GA"||state=="MS"||state=="LA"||state=="TN"||state=="SC"||state=="NC"||state=="WA"||state=="OR"||state=="ID"||state=="MT"||state=="ND"||state=="WY"||state=="HI"||state=="AL"||state=="FL"||state=="KS"){ oncee();changeto(1);check(1);} else if(state=="VA"||state=="WV"||state=="MD"||state=="DE"||state=="NJ"||state=="RI"||state=="MA"||state=="NH"||state=="VT"||state=="ME"||state=="NY"||state=="PA"||state=="MN"||state=="WI"||state=="IL"||state=="IN"||state=="OH"||state=="MI"||state=="KY"||state=="MO"||state=="AR"||state=="IA"||state=="SD"||state=="NE"||state=="CO"||state=="OK"||state=="AK"||state=="CT"){ oncee();changeto(2);check(1);} else if(state=="CA"||state=="NV"||state=="UT"||state=="AZ"||state=="NM"||state=="TX"){ oncee();changeto(3);check(1);}}